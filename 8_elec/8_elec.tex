...
%
\begin{equation}
 A = m \, \omega^2 \,  R	 \quad \text{also} \quad R = \frac{A}{m \omega^2} \quad .
\end{equation}
...
\end{eqnarray}
Wir führen den Huang-Rhys-Faktor $S$ als dimensionslose Kopplungskonstanten\sidenote{Kuzmany definiert  $S$ als Wurzel des hier verwendeten $S$.} ein
\begin{equation}
