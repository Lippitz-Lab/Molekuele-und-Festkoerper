...
\renewcommand{\lastmod}{3. Februar 2022}
...
Einstein macht nun auch die weitergehende Annahme, dass nur ein Oszillator zur  Zustandsdichte beiträgt, also $D(\omega) 3 N \, \delta(\omega_0 - \omega)$ bei $N$ Atomen im Kristall und 3 Dimensionen im Raum. Damit wird Gl.~\ref{eq:wk_u_allg}.
\begin{equation}
U(T) =  3N \, \frac{\hbar \omega_0 }{e^{\frac{\hbar \omega_0}{k_B \, T} }- 1} \quad .
\end{equation}
%bei $N$ Atomen im Kristall. Der zusätzliche Faktor 3 berücksichtigt die drei Schwingungs-Freiheitsgraden je Atom, den es in der Gesamt-Zustandsdichte ja noch gegeben hat. 
...
\begin{marginfigure}[0mm]
  ...
  \caption{\textit{oben:} Die mittlere Besetzung $\braket{n}$ eines Zustands nach der Bose-Einstein-Verteilung bei verschiedener Temperatur. \textit{oben:} Ableitung der Besetzung nach der Temperatur. In beiden Fällen tragen hauptsächlich Phononen mit $\hbar \omega < k_b T$ bei. }
  \end{marginfigure}
