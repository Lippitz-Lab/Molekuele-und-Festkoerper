...
\begin{marginfigure}
\caption{Primitive und nicht-primitive Basis-Vektoren und Einheitszellen in 2D Gitter, see AM fig.4.4}
\end{marginfigure}
...
\caption{Die 14 Bravais-Gitter \label{fig:gitter_bravais14}. Modifiziert nach Wikipedia. Gezeigt sind die konventionellen Einheitszellen, die die Symmetrie  des Gitters möglichst gut wiedergeben, aber im Falle der zentrierten Gitter nicht primitiv sind.
