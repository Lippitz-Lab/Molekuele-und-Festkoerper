...
Zur Berechnung der Bindungsenergie nehmen wir jetzt die nur vom Kern--Kern--Abstand $R$ abhängende Coulomb-Energie der Kerne wieder hinzu. Diese ist allerdings auch Bestandteil von $H_{12}$, so dass $S$ hier mit eingeht\sidenote{Da ist \cite{Haken_wolf_II} sehr geschickt formuliert! In \cite{McQuarrie2008} findet sich die vollständige Rechnung.}
%
\begin{eqnarray}
