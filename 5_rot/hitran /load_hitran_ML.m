...
wavenumber_samples_1_per_cm = (-20:0.5:520) ;
...
blurred_transmission = blurred_transmission(a:b);
	...
	figure;
	plot(wavenumber_samples_1_per_cm, (blurred_transmission));
    hold on
	%plot(wavenumber_samples_1_per_cm, (transmission_16_times_));
    hold off
    
	xlabel('Wavenumber (cm^-1)');
	ylabel('Transmission');
	title('HCl (from HITRAN)');

out = [wavenumber_samples_1_per_cm; blurred_transmission]';
save('hcl.dat','out','-ascii')
