...
\begin{figure}
\includegraphics[width=\textwidth]{\currfiledir oe/OE_n2_fig1_v2.pdf}
\caption{Raman-Spektrum von \ch{N2} in der Atmosphäre gemessen mit einem Laser der Wellenlänge 354.8~nm. Darstellung  modifiziert aus \cite{Liu14_OE_N2}. }
\end{figure}
