...
%\includeonly{anhang/1-2atom}
%\includeonly{anhang/julia}
%\includeonly{11_wk/11_wk, anhang/wk_einstein_debye}
...
\include{2_MO/2_MO}
\include{2_MO/2_MO_teil2}


%\part{Spektroskopie von Molekülen}
%
%\include{3_diel/3_diel}
%\include{4_rot/4_rot}
%\include{5_vib/5_vib}
%\include{6_raman/6_raman}
%\include{7_elec/7_elec}
%
%\part{Festkörperphysik I}
%%
%\include{8_gitter/8_gitter}
%\include{9_rezi/9_rezi}
%\include{10_phonon/10_phonon}
%\include{11_wk/11_wk}
